...
{block content}
    ...
    <h2>Instructions</h2>
    <ul>
        <li>Open and download CSV for report "Slate Import > Students" in PCR's DMT section</li>
        <li>Open the downloaded CSV in a text editor</li>
        <li>Search for empty columns filled with non-breaking-space and replace them with empty string</li>
